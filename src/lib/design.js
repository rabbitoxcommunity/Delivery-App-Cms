...
// Sidebar nav — [path, label, icon]. Paths are real routes (react-router-dom);
// NavLink's default prefix matching means `/products` stays highlighted on
// `/products/new` and `/products/:id/edit` too, with no extra logic needed.
export const NAV = [
  ['/live', 'Live Orders', 'M12 4a5 5 0 0 0-5 5v4l-2 3h14l-2-3V9a5 5 0 0 0-5-5ZM10 19a2 2 0 0 0 4 0'],
